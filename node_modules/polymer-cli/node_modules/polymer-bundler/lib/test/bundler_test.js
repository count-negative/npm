...
suite('Bundler', () => {
    ...
    suite('Excludes', () => {
        const excluded = preds.AND(preds.hasTagName('link'), preds.hasAttrValue('rel', 'import'), preds.hasAttrValue('href', 'imports/simple-import.html'));
        ...
        test.skip('Excluded CSS is not inlined', () => __awaiter(this, void 0, void 0, function* () {
            const doc = yield bundle(inputPath, { inlineCss: true, excludes: ['imports/simple-style.css'] });
