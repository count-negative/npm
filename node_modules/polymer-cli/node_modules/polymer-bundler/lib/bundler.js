...
class Bundler {
    ...
    _bundleDocument(docBundle, bundleManifest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.enableScriptInlining) {
                yield this._inlineScripts(document, ast, docBundle);
            }
            if (this.enableCssInlining) {
                yield this._inlineStylesheetLinks(document, ast, docBundle);
                yield this._inlineStylesheetImports(document, ast, docBundle);
            }
    ...
    _inlineHtmlImports(document, ast, bundle, bundleManifest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const htmlImport of htmlImports) {
                yield importUtils.inlineHtmlImport(this.analyzer, document, htmlImport, visitedUrls, bundle, bundleManifest, this.sourcemaps, this.rewriteUrlsInTemplates);
            }
        });
    }
    /**
     ...
     */
    _inlineScripts(document, ast, bundle) {
        return __awaiter(this, void 0, void 0, function* () {
            const scriptImports = dom5.queryAll(ast, matchers.externalJavascript);
            for (const externalScript of scriptImports) {
                yield importUtils.inlineScript(this.analyzer, document, externalScript, bundle, this.sourcemaps);
            }
        });
    }
    /**
     ...
     */
    _inlineStylesheetImports(document, ast, bundle) {
        return __awaiter(this, void 0, void 0, function* () {
            const cssImports = dom5.queryAll(ast, matchers.stylesheetImport);
            for (const cssLink of cssImports) {
                const style = yield importUtils.inlineStylesheet(this.analyzer, document, cssLink, bundle);
                if (style) {
     ...
     * relatively transposed as necessary.
     */
    _inlineStylesheetLinks(document, ast, bundle) {
        return __awaiter(this, void 0, void 0, function* () {
            const cssLinks = dom5.queryAll(ast, matchers.externalStyle);
            for (const cssLink of cssLinks) {
                yield importUtils.inlineStylesheet(this.analyzer, document, cssLink, bundle);
            }
        });
    }
    /**
