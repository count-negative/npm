...
const rewrite_webcomponents_loader_1 = require("./rewrite-webcomponents-loader");
...
function build(options, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (compiledToES5) {
            buildStream = buildStream.pipe(new rewrite_webcomponents_loader_1.InjectES5Adapter());
        }
