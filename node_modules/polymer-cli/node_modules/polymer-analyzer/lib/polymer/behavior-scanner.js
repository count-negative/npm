...
class BehaviorVisitor {
    ...
    enterObjectExpression(node, _parent) {
        ...
        for (let i = 0; i < node.properties.length; i++) {
            ...
            if (name in this.propertyHandlers) {
                ...
                this.currentBehavior.addProperty(js_utils_1.toScannedPolymerProperty(prop, this.document.sourceRangeForNode(prop), this.document));
            }
        }
    ...
    _initBehavior(node, getName) {
        ...
        this._startBehavior(new behavior_1.ScannedBehavior({
            ...
            sourceRange: this.document.sourceRangeForNode(node),
            privacy: js_utils_1.getOrInferPrivacy(symbol, parsedJsdocs),
        ...
        behavior.privacy = js_utils_1.getOrInferPrivacy(behavior.className, behavior.jsdoc);
